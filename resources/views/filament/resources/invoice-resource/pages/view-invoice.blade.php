<x-filament::page>
    <div class="space-y-6">
        <div class="p-4 bg-white rounded-lg shadow">
            <div class="flex justify-between items-start">
                ...
                <div class="text-right">
                    <h3 class="text-2xl font-bold text-primary-600">INVOICE</h3>
            ...
            <div class="p-4 bg-white rounded-lg shadow">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex justify-between py-2 border-b font-medium text-lg">
                        <span>Total:</span>
                        <span class="text-primary-600">{{ formatNaira($invoice->total_amount) }}</span>
                    </div>
        ...
        <div class="p-4 bg-white rounded-lg shadow text-center">
            <p class="text-sm italic text-gray-600">Thank you for your business!</p>
            <p class="text-xs text-gray-500 mt-1">This invoice was generated electronically and is valid without a physical signature.</p>
        </div>
    </div>
</x-filament::page>

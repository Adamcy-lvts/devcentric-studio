    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden w-full mt-5">
        <div class="">
            <x-jet-responsive-nav-link @click="triggerNavItem('#about')"
                class="font-light hover:bg-white hover:bg-opacity-50 uppercase text-white hover:text-teal-400 hover:border-teal-300 focus:bg-gray-50 focus:opacity-50 focus:text-teal-700 focus:border-teal-300 hover:bg-transparent"
                href="#">
                {{ __('About') }}
